  ...
  function playBoot() {
    return new Promise((resolve) => {
      ...
      wrap.innerHTML = `<video class="welcome-vid" autoplay muted loop playsinline src="assets/welcome.mp4"></video>
        ...
        <h2 id="bt">Checking account...</h2><p>𝑻𝑶𝑶𝑳𝑺 〆 𝑵𝑨𝑰𝑳𝑶𝑵𝑮</p><div class="bar"><i id="bp"></i></div></div>`;
  ...
  function shell(html) {
    ...
    return `<header class="topbar">
      <div class="brand" data-go="home"><img class="logo-img sm" src="assets/logo.jpg" alt="logo">
        <div class="brand-line">𝑻𝑶𝑶𝑳𝑺 〆 𝑵𝑨𝑰𝑳𝑶𝑵𝑮 <b>v148.027.00</b></div></div>
  ...
  function viewHome() {
    ...
    const html = `
      <section class="banner" id="bannerBox">
        <img class="banner-logo" src="assets/logo.jpg" alt="TOOLS x NAILONG">
